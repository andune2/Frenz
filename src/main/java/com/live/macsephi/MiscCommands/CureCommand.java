      ...
      if (this.me.hasPermission(player, "MobEffects.cure")) {
        if ((this.me.hasPermission(player, "MobEffects.cure.other")) && 
          ...
          if (target != player) {
            ...
            target.sendMessage(ChatColor.GREEN + player.getName() + " cast Cure on you!");
            target.sendMessage(ChatColor.GREEN + "[RES Lvl-1]");
            player.sendMessage(ChatColor.GREEN + "You cast Cure on " + target.getName() + "!");
        ...
        player.sendMessage(ChatColor.GREEN + "You cast Cure on yourself!");
        player.sendMessage(ChatColor.GREEN + "[RES Lvl-1]");
        return true;
      }
