    ...
    if ((sender instanceof Player)) {
      ...
      if (this.me.hasPermission(player, "MobEffects.curemore")) {
        if ((this.me.hasPermission(player, "MobEffects.curemore.other")) && 
          ...
          target.sendMessage(ChatColor.GREEN + player.getName() + " cast Cura on you!");
          target.sendMessage(ChatColor.GREEN + "[RES Lvl-2]");
          player.sendMessage(ChatColor.GREEN + "You cast Cura on " + target.getName() + "!");
        ...
        player.sendMessage(ChatColor.GREEN + "You cast Cura on yourself!");
        player.sendMessage(ChatColor.GREEN + "[RES Lvl-2]");
        return true;
      }
