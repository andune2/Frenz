      ...
      if (args.length == 1) {
        if (args[0].equalsIgnoreCase("fitforaking")) {
          if (this.me.hasPermission(player, "MobEffects.food.king")) {
            ...
            player.sendMessage(ChatColor.GREEN + "Your food bar has been filled!");
            return true;
          }
        ...
        if (args[0].equalsIgnoreCase("snack")) {
          if (this.me.hasPermission(player, "MobEffects.food.snack")) {
            ...
            player.sendMessage(ChatColor.GREEN + "You've eaten a snack!");
            return true;
          }
          player.sendMessage(ChatColor.DARK_RED + "You don't have permission to use this command.");
        }
        ...
        if (args[0].equalsIgnoreCase("meal")) {
          if (this.me.hasPermission(player, "MobEffects.food.meal")) {
            ...
            player.sendMessage(ChatColor.GREEN + "You've eaten a meal!");
            return true;
          }
          player.sendMessage(ChatColor.DARK_RED + "You don't have permission to use this command.");
        }
