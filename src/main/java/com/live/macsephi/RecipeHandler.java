  ...
  implements Listener
{
  ...
  private void handleRecipes() {
    ShapelessRecipe r = new ShapelessRecipe(new ItemStack(Material.DEAD_BUSH));
    r.addIngredient(Material.LONG_GRASS, 1).addIngredient(Material.getMaterial(368));
    this.server.addRecipe(r);

    r = new ShapelessRecipe(new ItemStack(Material.SMOOTH_BRICK, 1, 2));
    r.addIngredient(Material.WOOD_AXE, 50).addIngredient(Material.SMOOTH_BRICK);
    this.server.addRecipe(r);
    ...
    r.addIngredient(Material.SNOW_BALL).addIngredient(Material.SNOW_BALL).addIngredient(Material.SNOW_BALL);
    this.server.addRecipe(r);

    r = new ShapelessRecipe(new ItemStack(Material.WATER_LILY));
    r.addIngredient(Material.VINE).addIngredient(Material.VINE).addIngredient(Material.VINE);
    this.server.addRecipe(r);

    r = new ShapelessRecipe(new ItemStack(Material.INK_SACK, 1, 3));
    r.addIngredient(Material.SUGAR).addIngredient(Material.DIRT).addIngredient(Material.SUGAR);
    this.server.addRecipe(r);

    FurnaceRecipe f = new FurnaceRecipe(new ItemStack(Material.NETHER_BRICK), Material.NETHERRACK);
    this.server.addRecipe(f);

    f = new FurnaceRecipe(new ItemStack(Material.DRAGON_EGG), Material.ENDER_PORTAL);
    this.server.addRecipe(f);

    f = new FurnaceRecipe(new ItemStack(36), Material.DRAGON_EGG);
    this.server.addRecipe(f);

    f = new FurnaceRecipe(new ItemStack(Material.RECORD_11, 3), Material.SPONGE);
    this.server.addRecipe(f);
