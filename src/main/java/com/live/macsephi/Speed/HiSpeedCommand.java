...
public class HiSpeedCommand implements CommandExecutor {
            ...
            if (me.hasPluginPermission(this.player, "hispeed")) {
                ...
                this.me.getServer().getScheduler()
                        .scheduleSyncDelayedTask(this.me, new Runnable() {
                            public void run() {
                                if (HiSpeedCommand.this.player
                                        .hasPotionEffect(PotionEffectType.SPEED))
                                    HiSpeedCommand.this.player
                ...
                this.player.sendMessage(ChatColor.BLUE
                        + "You feel you can outrun any olympic expert.");
