...
public class DivineSpeedCommand implements CommandExecutor {
            ...
            if (Frenz.hasPermissions(this.player, "MobEffects.divinespeed")) {
                if (this.me.sDivine.contains(this.player)) {
                    ...
                    this.player.sendMessage(ChatColor.YELLOW
                            + "Your divine speed has subsided.");
                    return true;
                }
                ...
                this.player
                        .sendMessage(ChatColor.YELLOW
                                + "You stare into the distant clouds, praying for an enhancement to your speed. The gods adhere your wish, converting your bloodstream and cells into a super-highway, faster than a live circuit.");
