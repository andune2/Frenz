...
public class TemperBladeCommand
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
  {
    if ((sender instanceof Player)) {
      ...
      if (this.me.hasPermission(player, "MobEffects.temperblade")) {
        ...
        player.sendMessage(ChatColor.BLUE + "You carefully compress the metal of your blade with even hammer strokes, professionally tempering the blade.");
