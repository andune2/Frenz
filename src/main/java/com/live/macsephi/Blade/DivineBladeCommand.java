...
public class DivineBladeCommand
    ...
    if ((sender instanceof Player)) {
      ...
      if (this.me.hasPermission(player, "MobEffects.divineblade")) {
        if (this.me.bDivine.contains(player)) {
          ...
          player.sendMessage(ChatColor.YELLOW + "You have returned your blade to normal.");
          return true;
        }
        this.me.bDivine.add(player);
        player.sendMessage(ChatColor.YELLOW + "You raise your sword high in the air and wish to empower it. The gods adhere your wish, upgrading your sword to be unmatched by any other.");
