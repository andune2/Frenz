...
public class DeathBladeCommand
    ...
    if ((sender instanceof Player)) {
      ...
      if (this.me.hasPermission(player, "MobEffects.deathblade")) {
        if (this.me.death.contains(player)) {
          ...
          player.sendMessage(ChatColor.BLACK + "Your deathly aura has returned to the void from whence it came!");
          return true;
        }
        this.me.death.add(player);
        player.sendMessage(ChatColor.BLACK + "A deathly shroud forms around you, an aura visible to all in your presence!");
        return true;
      }
