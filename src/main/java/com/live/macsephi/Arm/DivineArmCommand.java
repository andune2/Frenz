    ...
    if ((sender instanceof Player)) {
      ...
      if (this.me.hasPermission(player, "MobEffects.divinearm")) {
        if (this.me.aDivine.contains(player)) {
          ...
          player.sendMessage(ChatColor.YELLOW + "Every drop of the divine energy in your arms has been drained.");
        }
        this.me.setMobEffect(player, 3, 12000, 6);
        this.me.aDivine.add(player);
        player.sendMessage(ChatColor.YELLOW + "You raise your arms up high and pray to be physically empowered. The gods adhere your wish, buffing your biceps and forearms to replicate even tree trunks.");
