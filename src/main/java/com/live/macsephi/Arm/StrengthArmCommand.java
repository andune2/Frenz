...
public class StrengthArmCommand
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
  {
    if ((sender instanceof Player)) {
      ...
      if (this.me.hasPermission(player, "MobEffects.strengtharm")) {
        ...
        player.sendMessage(ChatColor.BLUE + "Your arms feel as though you worked out for several hours, improving your use of tools.");
