...
public class PickaxeArmCommand
  implements CommandExecutor
{
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
  {
    if ((sender instanceof Player)) {
      ...
      if (this.me.hasPermission(player, "MobEffects.pickaxearm")) {
        this.me.setMobEffect(player, 3, 9600, 5);
        player.sendMessage(ChatColor.BLUE + "You are bestowed upon with unimaginable power within your arms. You feel as though you could mine obsidian with your bare hands!");
