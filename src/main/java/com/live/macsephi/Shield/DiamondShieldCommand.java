...
public class DiamondShieldCommand
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
  {
    if ((sender instanceof Player)) {
      ...
      if (this.plugin.hasPermission(player, "MobEffects.diamondshield")) {
        ...
        player.sendMessage(ChatColor.BLUE + "Your exterior hardens to that of pure diamond, vastly excelling even the best of armors.");
