...
public class ObsidianShieldCommand
    ...
    if ((sender instanceof Player)) {
      ...
      if (this.plugin.hasPermission(player, "MobEffects.obsidianshield")) {
        if (this.plugin.obsidian.contains(player)) {
          ...
          player.sendMessage(ChatColor.BLUE + "Your defense enhancement has subsided.");
          return true;
        }
        player.sendMessage(ChatColor.BLUE + "You have been blessed by the gods with a divine defensive infrastructure. Fatal wounds are mere tickling sensations.");
